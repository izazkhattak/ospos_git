...
class Reports extends Secure_Controller
{
	...
	public function summary_discounts_input()
	{
		...
		$data['sale_type_options']['attendance'] = 'Attendance';
	...
	public function summary_discounts($start_date, $end_date, $sale_type, $location_id = 'all', $discount_type=0)
	{
        ...
        if($sale_type == 'attendance')
            return $this->specific_employee_attendance($start_date, $end_date, $employee_id);
	...
	public function specific_employee_attendance($start_date, $end_date, $employee_id)
    {
        $headers = array(
            'summary' => array(
                array('login_time' => 'Login Time'),
                array('logout_time' => 'Logout Time'),
                array('extra_minutes'=> 'Extra Minutes'),
                array('missing_minutes' => 'Missing Minutes'),
        ...
        $report_data = $this->Employee->getAttendanceData($start_date, $end_date, $employee_id);
        ...
        $data = array(
            ...
            'headers' => $headers,
            'summary_data' => $summary_data,
            'overall_summary_data' => $this->xss_clean($this->Employee->getAttendanceSummary($start_date, $end_date, $employee_id))
        );
