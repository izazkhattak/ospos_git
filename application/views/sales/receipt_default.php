<div id="receipt_wrapper" style="font-size:<?php echo $this->config->item('receipt_font_size'); ?>px">
	...
	<table id="receipt_items">
		...
		?>
				<tr class="<?= $hide_class; ?>">
					<td><?php echo ($item['kit_name'] != null) ? ucfirst($item['kit_name']) : ucfirst($item['name']) . ' ' . $item['attribute_values']; ?></td>
					<td>
					<?php
						if($item['kit_name'] != NULL){
						?>
						<div class="price_view_<?= $kit_class_name; ?>"><?= to_currency($item['kit_total_temp_original_price']); ?></div>
						<?php }else{ ?>
							<?php echo to_currency($item['price']); ?>
						<?php } ?>
					</td>
					<td><?php echo to_quantity_decimals(($item['kit_name'] != null) ? $item['kit_temp'] : $item['quantity']); ?></td>
					<td class="total-value">
					<?php
						if($item['kit_name'] != NULL){
						?>
						<div class="kit_price_div_<?= $kit_class_name; ?>"><?= to_currency(bcmul($item['kit_total_temp_original_price'], $item['kit_temp'])); ?></div>
						<?php }else{ ?>
				...
				?>
					<tr class="<?= $hide_class; ?>">
						...
						<td class="total-value">
							<?php 
							if($item['kit_name'] != NULL){
								echo to_currency($item['kit_total_temp_price']);
							}else{
